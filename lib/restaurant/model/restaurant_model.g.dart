...
RestaurantModel _$RestaurantModelFromJson(Map<String, dynamic> json) => RestaurantModel(
...
Map<String, dynamic> _$RestaurantModelToJson(RestaurantModel instance) => <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
